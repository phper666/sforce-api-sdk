...
public class SerializedLambda implements Serializable {
    ...
    public static SerializedLambda resolve(SFunction<?, ?> lambda) {
        if (!lambda.getClass().isSynthetic()) {
            throw new IllegalArgumentException("This method can only accept synthetic classes generated by lambda expressions.");
        }
        byte[] bytes;
        ...
        try (ObjectInputStream objIn = new ObjectInputStream(new ByteArrayInputStream(Objects.requireNonNull(bytes))) {
            @Override
    ...
    public static Class<?> toClassConfident(String name) {
        try {
            ...
            throw new IllegalArgumentException("Class not found! Please call this method only when you are certain that the class exists.", e);
        }
    }
