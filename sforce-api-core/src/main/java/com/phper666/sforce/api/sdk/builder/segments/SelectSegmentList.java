...
import static com.phper666.sforce.api.sdk.builder.SoqlKeyword.FROM;
import static com.phper666.sforce.api.sdk.builder.SoqlKeyword.SELECT;
import static com.phper666.sforce.api.sdk.builder.StringPool.COMMA;
import static com.phper666.sforce.api.sdk.builder.StringPool.EMPTY;
import static com.phper666.sforce.api.sdk.builder.utils.SoqlUtil.getFields;
import static com.phper666.sforce.api.sdk.builder.utils.SoqlUtil.getObjectName;
